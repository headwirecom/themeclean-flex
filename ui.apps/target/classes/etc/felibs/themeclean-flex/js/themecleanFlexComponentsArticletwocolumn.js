var cmpThemecleanFlexComponentsArticletwocolumn = (function () {
    'use strict';
    ...
    var __vue_render__ = function() {
      ...
      return _c("themeclean-components-block", { attrs: { model: _vm.model } }, [
        _c(
          "div",
          {
            staticClass: "row col-12 col-md-8 d-flex justify-content-center article"
          },
          [
            _c("div", {
              staticClass: "col-12 col-md p-0 pr-md-3",
              domProps: { innerHTML: _vm._s(_vm.model.textleft) }
            }),
            _vm._v(" "),
            _c("div", {
              staticClass: "col-12 col-md p-0 pl-md-3",
              domProps: { innerHTML: _vm._s(_vm.model.textright) }
            }),
            _vm._v(" "),
            _vm.isEditAndEmpty
