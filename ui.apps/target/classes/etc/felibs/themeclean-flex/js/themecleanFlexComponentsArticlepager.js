var cmpThemecleanFlexComponentsArticlepager = (function () {
    'use strict';
    ...
    var __vue_render__ = function() {
      ...
      return _c("themeclean-components-block", { attrs: { model: _vm.model } }, [
        _c(
          "div",
          { staticClass: "d-flex justify-content-between col-12 col-md-8" },
          [
            _vm.isEditAndEmpty
            ...
            _c(
              "a",
              {
                staticClass: "btn btn-sm percms-btn-pager",
                class: {
                  disabled: _vm.model.previous === "unknown",
                  "btn-outline-primary": _vm.model.previous !== "unknown"
                },
                attrs: { href: _vm.$helper.pathToUrl(_vm.model.previous) }
              },
            ...
            _c(
              "a",
              {
                ...
                class: {
                  ...
                  "btn-outline-primary": _vm.model.next !== "unknown"
                },
                attrs: { href: _vm.$helper.pathToUrl(_vm.model.next) }
              },
