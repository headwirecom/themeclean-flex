var cmpThemecleanFlexComponentsFooter = (function () {
    ...
    var __vue_render__ = function() {
      ...
      return _c("themeclean-components-block", { attrs: { model: _vm.model } }, [
        _c("footer", { staticClass: "col-12" }, [
          _c(
            "div",
            { staticClass: "row justify-content-between text-center text-md-left" },
            [
              ...
              _vm._l(_vm.model.columns, function(item, i) {
                return _c(
                  "div",
                  { key: i, staticClass: "col-12 col-md pb-3 pb-md-0" },
                  [
                    item.title !== ""
          ...
          _c(
            "div",
            { staticClass: "row text-center text-md-left py-2" },
            [
              _c("div", { staticClass: "col-md-6" }, [
                _c("p", { domProps: { innerHTML: _vm._s(_vm.model.copyright) } })
              ]),
              _vm._v(" "),
              _c("themeclean-components-socialicons", {
