var cmpThemecleanFlexComponentsArticletextmedia = (function () {
    'use strict';
    ...
    var __vue_render__ = function() {
      ...
      return _c("themeclean-components-block", { attrs: { model: _vm.model } }, [
        _c(
          ...
          {
            staticClass:
              "row col-12 col-md-8 p-0 d-flex align-items-center justify-content-center flex-wrap article",
            class:
              _vm.model.mediaposition === "after" ? "flex-row-reverse" : "flex-row"
          },
          [
            _c(
              "div",
              {
                staticClass: "col-12 col-lg-auto pb-3 p-lg-0 px-lg-3",
                style: { width: _vm.model.mediawidth + "%" }
              },
              [_c("themeclean-components-media", { attrs: { model: _vm.model } })],
              1
            ),
            _vm._v(" "),
            _c("div", {
