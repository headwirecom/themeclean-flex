var cmpThemecleanFlexComponentsTextlinks = (function () {
    ...
    var __vue_render__ = function() {
      ...
      return _c(
        "ul",
        { staticClass: "navbar-nav nav-dropdown text-right" },
        _vm._l(_vm.model.links, function(item, i) {
          return _c("li", { key: i, staticClass: "nav-item" }, [
            _c("a", {
              staticClass: "nav-link",
              class: {
                "text-dark": _vm.model.colorscheme === "light",
                "text-light": _vm.model.colorscheme === "dark"
              },
              attrs: { href: _vm.$helper.pathToUrl(item.link) },
