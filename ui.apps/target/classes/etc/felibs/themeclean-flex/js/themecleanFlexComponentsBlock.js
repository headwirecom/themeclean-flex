var cmpThemecleanFlexComponentsBlock = (function () {
    ...
    var script = {
        ...
        mounted: function mounted() {
          ...
          var navSection = document.querySelector('nav').parentElement.parentElement.parentElement;
    ...
    var __vue_render__ = function() {
      ...
      return _c(
        ...
        [
          _c("a", {
            ref: "anchor",
            staticClass: "percms-anchor",
            attrs: { id: _vm.model.anchorname }
          }),
          _vm._v(" "),
            ...
            ? _c(
                ...
                [
                  _c("iframe", {
                    ...
                    attrs: {
                      src:
                        _vm.model.bgvideo + "?autoplay=1&loop=1&controls=0&mute=1"
                    }
                  })
                ]
              )
          ...
          _c(
            ...
            {
              class:
                _vm.model.fullwidth === "true" ? "container-fluid" : "container"
            },
            [
              _c(
                "div",
