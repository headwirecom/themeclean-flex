var cmpThemecleanFlexComponentsArticlequote = (function () {
    'use strict';
    ...
    var __vue_render__ = function() {
      ...
      return _c("themeclean-components-block", { attrs: { model: _vm.model } }, [
        _c("div", { staticClass: "col-12 col-md-8 article" }, [
          _vm.model.blockquote == "false"
            ? _c("hr", {
                staticClass: "line",
                class: {
                  "border-secondary": _vm.model.colorscheme === "",
                  "border-dark": _vm.model.colorscheme === "light",
                  "border-light": _vm.model.colorscheme === "dark"
                },
                style: "width:" + (_vm.model.linewidth + "%") + ";"
              })
            : _vm._e(),
          _vm._v(" "),
          _c("div", {
            ...
            class: {
              "percms-blockquote": _vm.model.blockquote === "true",
              "border-secondary": _vm.model.colorscheme === "",
              "border-dark": _vm.model.colorscheme === "light",
              "border-light": _vm.model.colorscheme === "dark"
            },
