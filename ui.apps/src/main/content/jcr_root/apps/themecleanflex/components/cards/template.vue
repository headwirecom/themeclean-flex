<template>
  <themecleanflex-components-block v-bind:model="model" class='component-cards'>
      ...
      <div class="card my-3 px-0 md:px-3" v-bind:class="{
        ...
        v-bind:class="{
          ...
          <div class="flex flex-grow flex-col justify-between p-0" v-bind:class="{
            ...
            <div>
              <h2 class="text-xl mb-3" v-if="model.showtitle == 'true'" v-bind:data-per-inline="`model.cards.${i}.title`"
