<template>
  <themecleanflex-components-block v-bind:model="model" class='component-teaserhorizontal'>
    ...
    v-bind:class="{
      ...
      v-bind:class="{
        ...
        }" v-bind:data-per-inline="`model.buttons.${i}.buttontext`" v-bind:style="`backgroundColor:${item.buttoncolor};borderColor:${item.buttoncolor};`">{{item.buttontext}}</a>
      </div>
    </div>
