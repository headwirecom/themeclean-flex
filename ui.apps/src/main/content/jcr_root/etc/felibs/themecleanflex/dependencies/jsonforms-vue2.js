(function (global, factory) {
...
})(this, function (exports, compositionApi, maxBy, core) {
	"use strict";
	...
	var arrayControlInit = function arrayControlInit() {
		return _objectSpread2(
			_objectSpread2({}, controlWithDetailInit()),
			{},
			{
				childErrors: null,
				renderers: null,
	...
	function useControl(props, stateInit, stateMap, dispatchMap) {
			...
			Object.assign(
				...
				stateMap(
					...
					_objectSpread2(
						...
						{
							id:
								(_control$value$id = control.value.id) !==
									null && _control$value$id !== void 0
									? _control$value$id
									: undefined,
						}
					)
		...
		compositionApi.watch(
			function () {
				return [].concat(_toConsumableArray(Object.values(jsonforms)), [
					props,
				]);
			},
			function () {
		...
		var dispatchMethods =
			dispatchMap === null || dispatchMap === void 0
				? void 0
	...
	var useJsonFormsControl = function useJsonFormsControl(props) {
		return useControl(
			props,
			controlInit,
			core.mapStateToControlProps,
			core.mapDispatchToControlProps
		);
	};
	/**
	...
	var useJsonFormsControlWithDetail = function useJsonFormsControlWithDetail(
		props
	) {
		return useControl(
			props,
			controlWithDetailInit,
			core.mapStateToControlWithDetailProps,
			core.mapDispatchToControlProps
		);
	};
	/**
	...
	var useJsonFormsEnumControl = function useJsonFormsEnumControl(props) {
		return useControl(
			props,
			enumControlInit,
			core.mapStateToEnumControlProps,
			core.mapDispatchToControlProps
		);
	};
	/**
	...
	var useJsonFormsOneOfEnumControl = function useJsonFormsOneOfEnumControl(
		props
	) {
		return useControl(
			props,
			enumControlInit,
			core.mapStateToOneOfEnumControlProps,
			core.mapDispatchToControlProps
		);
	};
	/**
	...
	var useJsonFormsArrayControl = function useJsonFormsArrayControl(props) {
		return useControl(
			props,
			arrayControlInit,
			core.mapStateToArrayControlProps,
			core.mapDispatchToArrayControlProps
		);
	};
	/**
	...
	var useJsonFormsLayout = function useJsonFormsLayout(props) {
		var _useControl = useControl(
				props,
				layoutInit,
				core.mapStateToLayoutProps
			),
	...
	var useJsonFormsArrayLayout = function useJsonFormsArrayLayout(props) {
		var _useControl2 = useControl(
				props,
				arrayLayoutInit,
				core.mapStateToArrayLayoutProps
			),
	...
	var useJsonFormsMasterListItem = function useJsonFormsMasterListItem(
		props
	) {
		var _useControl3 = useControl(
				props,
				masterListItemInit,
				core.mapStateToMasterListItemProps
			),
	...
	var useJsonFormsRenderer = function useJsonFormsRenderer(props) {
		...
		var updateRenderer = function updateRenderer(jsonforms, props) {
			var _mapStateToJsonFormsR = core.mapStateToJsonFormsRendererProps(
				...
				other = _objectWithoutProperties(_mapStateToJsonFormsR, [
					"refResolver",
				]);
	...
	var useJsonFormsCell = function useJsonFormsCell(props) {
		var _useControl4 = useControl(
				props,
				cellInit,
				core.mapStateToCellProps,
				core.mapDispatchToControlProps
			),
	...
	var useJsonFormsEnumCell = function useJsonFormsEnumCell(props) {
		var _useControl5 = useControl(
				props,
				enumCellInit,
				core.defaultMapStateToEnumCellProps,
				core.mapDispatchToControlProps
			),
	...
	var useJsonFormsDispatchCell = function useJsonFormsDispatchCell(props) {
		var _useControl6 = useControl(
				props,
				cellInit,
				core.mapStateToDispatchCellProps,
				core.mapDispatchToControlProps
			),
	...
	var script$2 = compositionApi.defineComponent({
		...
		computed: {
			determinedRenderer: function determinedRenderer() {
				...
				var renderer = maxBy__default["default"](
					this.renderer.renderers,
					function (r) {
						return r.tester(
							_this.renderer.uischema,
							_this.renderer.schema
						);
					}
				);
	...
	var script$1 = compositionApi.defineComponent({
		...
		computed: {
			determinedCell: function determinedCell() {
				...
				var cell = maxBy__default["default"](
					this.cell.cells,
					function (r) {
	...
	var script = compositionApi.defineComponent({
		...
		data: function data() {
			...
			var schemaToUse =
				(_this$schema = this.schema) !== null && _this$schema !== void 0
					? _this$schema
					: core.Generate.jsonSchema(generatorData);
			var uischemaToUse =
				(_this$uischema = this.uischema) !== null &&
				_this$uischema !== void 0
					? _this$uischema
					: core.Generate.uiSchema(schemaToUse);
			...
			var initCore = function initCore() {
				...
				var core$1 = core.coreReducer(
					initialCore,
					core.Actions.init(_this.data, schemaToUse, uischemaToUse, {
			...
			return {
				...
				jsonforms: {
					core: initCore(),
					config: core.configReducer(
						undefined,
						core.Actions.setConfig(this.config)
					),
		...
		watch: {
			schema: function schema(newSchema) {
				var generatorData = isObject(this.data) ? this.data : {};
				this.schemaToUse =
					newSchema !== null && newSchema !== void 0
						? newSchema
						: core.Generate.jsonSchema(generatorData);

				if (!this.uischema) {
					this.uischemaToUse = core.Generate.uiSchema(
						this.schemaToUse
					);
				}
			},
			uischema: function uischema(newUischema) {
				this.uischemaToUse =
					newUischema !== null && newUischema !== void 0
						? newUischema
						: core.Generate.uiSchema(this.schemaToUse);
			},
			...
			config: {
				handler: function handler(newConfig) {
					this.jsonforms.config = core.configReducer(
						undefined,
						core.Actions.setConfig(newConfig)
					);
				},
				deep: true,
			},
			...
			coreDataToUpdate: function coreDataToUpdate() {
				this.jsonforms.core = core.coreReducer(
					this.jsonforms.core,
					core.Actions.updateCore(
						this.data,
						this.schemaToUse,
						this.uischemaToUse,
						{
