const jsonForms2VanillaInitInverval = setInterval(() => {(function (global, factory) {
...
}(this, (function (exports, core, compositionApi, vue2, merge, cloneDeep, mergeWith) { 'use strict';
  ...
  var updateOptions = function updateOptions(appliedOptionsRef, controlRef) {
    appliedOptionsRef.value = merge__default['default']({}, cloneDeep__default['default'](controlRef.value.config), cloneDeep__default['default'](controlRef.value.uischema.options));
  };
  /**
  ...
  var useVanillaControl = function useVanillaControl(input) {
    ...
    compositionApi.watch(function () {
      return [input.control.value.config, input.control.value.uischema];
    }, function () {
      updateOptions(appliedOptions, input.control);
    });
  ...
  var useVanillaLayout = function useVanillaLayout(input) {
    ...
    compositionApi.watch(function () {
      return [input.layout.value.config, input.layout.value.uischema];
    }, function () {
      updateOptions(appliedOptions, input.layout);
    });
    return _objectSpread2(_objectSpread2({}, input), {}, {
  ...
  var updateUiSchema = function updateUiSchema(uiSchemaRef, controlRef) {
    uiSchemaRef.value = core.findUISchema(controlRef.value.uischemas, controlRef.value.schema, controlRef.value.uischema.scope, controlRef.value.path);
  };
  /**
  ...
  var useVanillaArrayControl = function useVanillaArrayControl(input) {
    ...
    compositionApi.watch(function () {
      return [input.control.value.uischemas, input.control.value.schema, input.control.value.uischema.scope, input.control.value.path];
    }, function () {
      updateUiSchema(childUiSchema, input.control);
    });
  ...
  var listItem = compositionApi.defineComponent({
    ...
    methods: {
      ...
      moveUpClicked: function moveUpClicked(event) {
        ...
        (_this$moveUp = this.moveUp) === null || _this$moveUp === void 0 ? void 0 : _this$moveUp.call(this);
      },
      moveDownClicked: function moveDownClicked(event) {
        var _this$moveDown;

        event.stopPropagation();
        (_this$moveDown = this.moveDown) === null || _this$moveDown === void 0 ? void 0 : _this$moveDown.call(this);
      },
      deleteClicked: function deleteClicked(event) {
        var _this$delete;

        event.stopPropagation();
        (_this$delete = this["delete"]) === null || _this$delete === void 0 ? void 0 : _this$delete.call(this);
      }
    }
  });
  ...
  var __vue_render__$f = function __vue_render__() {
    ...
    }, [_vm._v(_vm._s(_vm.label))]), _vm._v(" "), _c('button', {
  ...
  var controlRenderer$a = compositionApi.defineComponent({
    ...
    setup: function setup(props) {
      return useVanillaArrayControl(vue2.useJsonFormsArrayControl(props));
    },
    computed: {
  ...
  var __vue_render__$e = function __vue_render__() {
    ...
    return _vm.control.visible ? _c('fieldset', {
    ...
    }, [_vm._v("\n      " + _vm._s(_vm.control.label) + "\n    ")])]), _vm._v(" "), _vm._l(_vm.control.data, function (element, index) {
      return _c('div', {
        key: _vm.control.path + "-" + index,
        "class": _vm.styles.arrayList.itemWrapper
      }, [_c('array-list-element', {
        attrs: {
          "moveUp": _vm.moveUp(_vm.control.path, index),
          "moveUpEnabled": index > 0,
          "moveDown": _vm.moveDown(_vm.control.path, index),
          "moveDownEnabled": index < _vm.control.data.length - 1,
          "delete": _vm.removeItems(_vm.control.path, [index]),
          "label": _vm.childLabelForIndex(index),
          "styles": _vm.styles
        }
      }, [_c('dispatch-renderer', {
        attrs: {
          "schema": _vm.control.schema,
          "uischema": _vm.childUiSchema,
  ...
  var __vue_render__$d = function __vue_render__() {
    ...
    return _vm.visible ? _c('div', {
      ...
      "class": _vm.errors ? _vm.styles.control.error : _vm.styles.control.description
    }, [_vm._v("\n    " + _vm._s(_vm.errors ? _vm.errors : _vm.showDescription ? _vm.description : null) + "\n  ")])]) : _vm._e();
  };
  ...
  var __vue_render__$c = function __vue_render__() {
    ...
    }, 'control-wrapper', _vm.control, false), [_c('input', {
  ...
  var __vue_render__$b = function __vue_render__() {
    ...
    }, 'control-wrapper', _vm.control, false), [_c('textarea', {
  ...
  var controlRenderer$7 = compositionApi.defineComponent({
    ...
    props: _objectSpread2({}, vue2.rendererProps()),
    setup: function setup(props) {
      return useVanillaControl(vue2.useJsonFormsControl(props), function (target) {
  ...
  var __vue_render__$8 = function __vue_render__() {
    ...
    }, 'control-wrapper', _vm.control, false), [_c('select', {
    ...
    }), _vm._v(" "), _vm._l(_vm.control.options, function (optionElement) {
      return _c('option', {
  ...
  var controlRenderer$4 = compositionApi.defineComponent({
    ...
    props: _objectSpread2({}, vue2.rendererProps()),
    setup: function setup(props) {
      return useVanillaControl(vue2.useJsonFormsOneOfEnumControl(props));
    }
  });
  var entry$7 = {
  ...
  var controlRenderers = [entry$c, entry$b, entry$a, entry$9, entry$8, entry$7, entry$6, entry$5, entry$4, entry$3];
  ...
  var __vue_render__$2 = function __vue_render__() {
    ...
    }, _vm._l(_vm.layout.uischema.elements, function (element, index) {
      return _c('div', {
  ...
  var __vue_render__$1 = function __vue_render__() {
    ...
    return _vm.layout.visible ? _c('fieldset', {
      "class": _vm.styles.group.root
    }, [_vm.layout.uischema.label ? _c('legend', {
      "class": _vm.styles.group.label
    }, [_vm._v("\n    " + _vm._s(_vm.layout.uischema.label) + "\n  ")]) : _vm._e(), _vm._v(" "), _vm._l(_vm.layout.uischema.elements, function (element, index) {
      return _c('div', {
        key: _vm.layout.path + "-" + index,
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _vm.layout.visible ? _c('label', {
  ...
  var vanillaRenderers = [].concat(_toConsumableArray(controlRenderers), _toConsumableArray(layoutRenderers), _toConsumableArray(arrayRenderers), _toConsumableArray(labelRenderers));
