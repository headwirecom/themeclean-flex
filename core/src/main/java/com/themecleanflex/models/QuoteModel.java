...
public class QuoteModel extends AbstractComponent {
    ...
    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Text","x-form-group":"content","x-form-type":"texteditor"} */
	@Inject
	private String text;

	/* {"type":"string","x-source":"inject","x-form-label":"Block Quote?","x-form-type":"materialswitch","x-form-group":"style","x-default":"false"} */
	@Inject
