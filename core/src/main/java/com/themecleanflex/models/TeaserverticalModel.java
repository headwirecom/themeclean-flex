...
public class TeaserverticalModel extends AbstractComponent {
  ...
  //GEN[:INJECT
  /* {"type":"string","x-source":"inject","x-form-label":"Align Content","x-form-type":"materialradio","x-default":"center","x-form-group":"style","properties":{"left":{"x-form-name":"Left","x-form-value":"left"},"center":{"x-form-name":"Center","x-form-value":"center"},"right":{"x-form-name":"Right","x-form-value":"right"}}} */
  @Inject
  @Default(values = "center")
  private String aligncontent;

  /* {"type":"string","x-source":"inject","x-form-label":"Enlarge Text","x-form-type":"materialswitch","x-form-group":"style","x-form-default":"false"} */
  @Inject
  ...
  /* {"type":"string","x-source":"inject","x-form-label":"Subtitle","x-form-visible":"model.showsubtitle == 'true'","x-form-group":"content","x-form-rows":3,"x-form-type":"textarea"} */
  @Inject
  private String subtitle;

  /* {"type":"string","x-source":"inject","x-form-label":"Show Text","x-form-group":"style","x-form-type":"materialswitch"} */
  @Inject
  private String showtext;

  /* {"type":"string","x-source":"inject","x-form-label":"Text","x-form-visible":"model.showtext == 'true'","x-form-group":"content","x-form-type":"texteditor"} */
  @Inject
  private String text;

  /* {"type":"string","x-source":"inject","x-form-label":"Text Width","x-form-type":"materialrange","x-form-group":"style","x-form-min":0,"x-form-max":100,"x-default":100} */
  @Inject
  @Default(values = "100")
  private String textwidth;

  /* {"type":"string","x-source":"inject","x-form-label":"Show Button","x-form-group":"style","x-form-type":"materialswitch"} */
  @Inject
  private String showbutton;

  /* {"type":"string","x-source":"inject","x-form-label":"Button Alignment","x-form-visible":"","x-form-type":"materialradio","x-form-group":"style","x-default":"center","properties":{"left":{"x-form-name":"Left","x-form-value":"start"},"center":{"x-form-name":"Center","x-form-value":"center"},"right":{"x-form-name":"Right","x-form-value":"end"}}} */
  @Inject
  @Default(values = "center")
  private String alignbuttons;

  /* {"type":"string","x-source":"inject","x-form-label":"Button Size","x-form-type":"materialselect","x-form-visible":"model.showbutton == 'true'","x-default":"default","x-form-group":"style","properties":{"default":{"x-form-name":"Default","x-form-value":"default"},"large":{"x-form-name":"Large","x-form-value":"large"},"small":{"x-form-name":"Small","x-form-value":"small"}}} */
  @Inject
  @Default(values = "default")
  private String buttonsize;

  /* {"type":"string","x-source":"inject","x-form-label":"Buttons","x-form-type":"collection","x-form-group":"content","x-form-visible":"model.showbutton == 'true'","properties":{"buttontext":{"type":"string","x-source":"inject","x-form-label":"Button Text","x-form-type":"text"},"buttonlink":{"type":"string","x-source":"inject","x-form-label":"Button Link","x-form-type":"pathbrowser","x-form-browserRoot":"/content/themecleanflex/pages"},"buttoncolor":{"type":"string","x-source":"inject","x-form-label":"Button Color","x-form-type":"materialselect","x-default":"primary","properties":{"primary":{"x-form-name":"Primary","x-form-value":"primary"},"secondary":{"x-form-name":"Secondary","x-form-value":"secondary"},"success":{"x-form-name":"Success","x-form-value":"success"},"danger":{"x-form-name":"Danger","x-form-value":"danger"},"warning":{"x-form-name":"Warning","x-form-value":"warning"},"info":{"x-form-name":"Info","x-form-value":"info"},"light":{"x-form-name":"Light","x-form-value":"light"},"dark":{"x-form-name":"Dark","x-form-value":"dark"}}}}} */
  @Inject
