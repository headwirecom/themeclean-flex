...
/*
  ...
  "name": "Button",
  "componentPath": "themecleanflex/components/button",
  "package": "com.themecleanflex.models",
  "modelName": "Button",
...
@Model(
        ...
        resourceType = "themecleanflex/components/button",
...
//GEN]
public class ButtonModel extends AbstractComponent {

    public ButtonModel(final Resource r) { super(r); }
