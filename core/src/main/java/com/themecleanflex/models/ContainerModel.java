...
public class ContainerModel extends Container {
	...
	/* {"type":"string","x-source":"inject","x-form-label":"Container Width (Tablet)","x-form-type":"materialradio","x-default":"auto","properties":{"auto":{"x-form-name":"Auto (fill available space)","x-form-value":"auto"},"custom":{"x-form-name":"Custom","x-form-value":"custom"}}} */
	@Inject
	@Default(values ="auto")
	private String tabletwidth;

	/* {"type":"string","x-source":"inject","x-form-label":"Column Span (12 Columns)","x-form-type":"materialrange","x-form-min":1,"x-form-max":12,"x-form-visible":"model.tabletwidth == 'custom'","x-default":12} */
	@Inject
	@Default(values ="12")
	private String tabletcolspan;

	/* {"type":"string","x-source":"inject","x-form-label":"Container Width (Mobile)","x-form-type":"materialradio","x-default":"auto","properties":{"auto":{"x-form-name":"Auto (fill available space)","x-form-value":"auto"},"custom":{"x-form-name":"Custom","x-form-value":"custom"}}} */
	@Inject
	@Default(values ="auto")
	private String mobilewidth;

	/* {"type":"string","x-source":"inject","x-form-label":"Column Span (12 Columns)","x-form-type":"materialrange","x-form-min":1,"x-form-max":12,"x-form-visible":"model.mobilewidth == 'custom'","x-default":12} */
	@Inject
	@Default(values ="12")
