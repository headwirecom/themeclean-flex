...
public class HeaderModel extends AbstractComponent {
    ...
    //GEN[:INJECT
    /* {"type":"string","x-source":"inject","x-form-label":"Logo","x-form-type":"pathbrowser","x-form-group":"content","x-form-browserRoot":"/content/themecleanflex/assets"} */
    @Inject
    private String logo;

    /* {"type":"string","x-source":"inject","x-form-label":"Logo Alt Text","x-form-group":"content","x-form-type":"text"} */
    @Inject
    private String logoalttext;

    /* {"type":"string","x-source":"inject","x-form-label":"Logo Url","x-form-group":"content","x-form-type":"pathbrowser","x-form-browserRoot":"/content/themecleanflex/pages"} */
    @Inject
    private String logourl;

    /* {"type":"string","x-source":"inject","x-form-label":"Logo Size","x-form-group":"content","x-form-type":"materialrange","x-default":50,"x-form-min":1,"x-form-max":300} */
    @Inject
    @Default(values = "50")
    private String logosize;

    /* {"type":"string","x-source":"inject","x-form-label":"Collapse Menu","x-form-group":"style","x-form-type":"materialswitch"} */
    @Inject
    private String collapsed;

    /* {"type":"string","x-source":"inject","x-form-label":"Elevation","x-form-visible":"","x-form-group":"style","x-form-type":"materialrange","x-default":0,"x-form-min":0,"x-form-max":5} */
    @Inject
    private String elevation;

    /* {"type":"string","x-source":"inject","x-form-label":"Sticky","x-form-group":"style","x-form-type":"materialswitch"} */
    @Inject
    private String sticky;

    /* {"type":"object","x-source":"inject","x-form-group":"content","x-form-type":"collection","x-form-label":"Links","properties":{"text":{"type":"string","x-source":"inject","x-form-label":"Link Text","x-form-type":"text"},"link":{"type":"string","x-source":"inject","x-form-label":"Link Url","x-form-type":"pathbrowser","x-form-browserRoot":"/content/themecleanflex/pages"}}} */
    @Inject
