...
public class FooterModel extends AbstractComponent {
    ...
    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Show Logo","x-form-group":"style","x-form-type":"materialswitch"} */
	@Inject
	private String showlogo;

	/* {"type":"string","x-source":"inject","x-form-label":"Logo","x-form-type":"pathbrowser","x-form-visible":"model.showlogo == 'true'","x-form-group":"content","x-form-browserRoot":"/content/themecleanflex/assets"} */
	@Inject
	private String logo;

	/* {"type":"string","x-source":"inject","x-form-label":"Logo Alt Text","x-form-group":"content","x-form-visible":"model.showlogo == 'true'","x-form-type":"text"} */
	@Inject
	private String logoalttext;

	/* {"type":"string","x-source":"inject","x-form-label":"Logo Url","x-form-type":"pathbrowser","x-form-group":"content","x-form-visible":"model.showlogo == 'true'","x-form-browserRoot":"/content/themecleanflex/pages"} */
	@Inject
	private String logourl;

	/* {"type":"string","x-source":"inject","x-form-label":"Logo Size","x-form-group":"content","x-form-type":"materialrange","x-form-visible":"model.showlogo == 'true'","x-form-min":1,"x-form-max":300} */
	@Inject
	private String logosize;

	/* {"type":"string","x-source":"inject","x-form-label":"Columns","x-form-type":"collection","x-form-group":"content","x-form-multifield":"true","properties":{"title":{"type":"string","x-source":"inject","x-form-label":"Title","x-form-type":"text"},"text":{"type":"string","x-source":"inject","x-form-label":"Text","x-form-type":"texteditor"}}} */
	@Inject
	private List<IComponent> columns;

	/* {"type":"string","x-source":"inject","x-form-label":"Copyright Text","x-form-group":"content","x-form-type":"text"} */
	@Inject
