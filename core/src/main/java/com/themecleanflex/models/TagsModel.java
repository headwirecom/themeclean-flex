...
public class TagsModel extends AbstractComponent {
	...
	public TagsModel(Resource r) {
		super(r);
	}

	//GEN[:INJECT
	/* {"type":"string","x-source":"inject","x-form-label":"Tags Label","x-form-group":"content","x-form-type":"text"} */
	@Inject
	private String tagslabel;

	/* {"type":"string","x-source":"inject","x-form-label":"Tag Color","x-form-type":"materialselect","x-form-group":"style","x-default":"blue","properties":{"note":{"x-form-name":"Blue","x-form-value":"blue"},"tip":{"x-form-name":"Green","x-form-value":"green"},"important":{"x-form-name":"Orange","x-form-value":"orange"},"caution":{"x-form-name":"Red","x-form-value":"red"},"warning":{"x-form-name":"Yellow","x-form-value":"yellow"}}} */
	@Inject
	@Default(values = "blue")
	private String tagcolor;

	/* {"type":"string","x-source":"inject","x-form-label":"Tag Link Base Path","x-form-group":"content","x-form-type":"pathbrowser","x-form-browserRoot":"/content/themecleanflex/pages"} */
	@Inject
