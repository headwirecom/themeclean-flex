...
/*
    ...
    "Form": {
      ...
      "properties": {
        "data": {
          "type": "string",
          "x-source": "inject",
          "x-form-label": "Form Definition (JSON)",
          "x-form-rows": 20,
  ...
  "name": "Form",
  "componentPath": "themecleanflex/components/form",
  "package": "com.themecleanflex.models",
  "modelName": "Form",
...
@Model(
        ...
        resourceType = "themecleanflex/components/form",
...
public class FormModel extends AbstractComponent {
    ...
    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Form Definition (JSON)","x-form-rows":20,"x-form-type":"textarea"} */
	@Inject
	private String data;
