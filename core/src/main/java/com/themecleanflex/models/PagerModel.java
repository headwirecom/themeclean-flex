...
public class PagerModel extends AbstractComponent {
  ...
  /* {"type":"string","x-source":"inject","x-form-label":"Include Root","x-form-group":"content","x-form-type":"materialswitch","x-default":false} */
  @Inject
  private String includeroot;

  /* {"type":"string","x-source":"inject","x-form-label":"Button Size","x-form-type":"materialselect","x-form-group":"style","x-default":"default","properties":{"default":{"x-form-name":"Default","x-form-value":"default"},"large":{"x-form-name":"Large","x-form-value":"large"},"small":{"x-form-name":"Small","x-form-value":"small"}}} */
  @Inject
  @Default(values = "default")
  private String buttonsize;

  /* {"type":"string","x-source":"inject","x-form-label":"Button Color","x-form-type":"materialselect","x-form-group":"style","x-default":"primary","properties":{"primary":{"x-form-name":"Primary","x-form-value":"primary"},"secondary":{"x-form-name":"Secondary","x-form-value":"secondary"},"success":{"x-form-name":"Success","x-form-value":"success"},"danger":{"x-form-name":"Danger","x-form-value":"danger"},"warning":{"x-form-name":"Warning","x-form-value":"warning"},"info":{"x-form-name":"Info","x-form-value":"info"},"light":{"x-form-name":"Light","x-form-value":"light"},"dark":{"x-form-name":"Dark","x-form-value":"dark"}}} */
  @Inject
  @Default(values = "primary")
  private String buttoncolor;

  /* {"type":"string","x-source":"inject","x-form-label":"Previous Label","x-form-type":"text","x-form-group":"content","x-default":"Previous"} */
  @Inject
  @Default(values = "Previous")
  private String prevlabel;

  /* {"type":"string","x-source":"inject","x-form-label":"Next Label","x-form-type":"text","x-form-group":"content","x-default":"Next"} */
  @Inject
  @Default(values = "Next")
  private String nextlabel;

  /* {"type":"string","x-source":"inject","x-form-label":"Disable the previous button","x-form-type":"materialswitch","x-form-group":"content","x-default":false} */
  @Inject
  private String disableprevious;

  /* {"type":"string","x-source":"inject","x-form-label":"Exclude pages Excluded in Sitemap","x-form-group":"content","x-form-type":"materialswitch","x-default":false} */
  @Inject
  ...
  public String getRootPage() {
    ...
    if (rootpage.endsWith("/")) return rootpage.substring(
      0,
      rootpage.length() - 1
    );
    return rootpage;
  ...
  public String getPrevious() {
    ...
    if (Boolean.parseBoolean(getExcludeSitemapExcludes())) {
      while (
        prev != null &&
        prev.getContentProperty(PerConstants.EXCLUDE_FROM_SITEMAP, false)
      ) {
  ...
  public String getNext() {
    ...
    if (Boolean.parseBoolean(getExcludeSitemapExcludes())) {
      while (
        next != null &&
        next.getContentProperty(PerConstants.EXCLUDE_FROM_SITEMAP, false)
      ) {
        next = next.getNext();
      }
    }
  ...
  private Resource getCurrentPage(Resource resource) {
    ...
    try {
      ...
      LOG.debug(
        "resource type is: " + resourceType + "  path is:" + resource.getPath()
      );
