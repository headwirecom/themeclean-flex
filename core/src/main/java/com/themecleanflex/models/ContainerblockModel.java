...
public class ContainerblockModel extends Container {
    ...
    public ContainerblockModel(Resource r) {
        super(r);
    }

    //GEN[:INJECT
    /* {"type":"string","x-source":"inject","x-form-label":"Items Alignment","x-form-type":"materialselect","x-form-group":"content","x-default":"primary","properties":{"start":{"x-form-name":"Start","x-form-value":"items-start"},"center":{"x-form-name":"Center","x-form-value":"items-center"},"end":{"x-form-name":"End","x-form-value":"items-end"},"stretch":{"x-form-name":"Stretch","x-form-value":"items-stretch"},"baseline":{"x-form-name":"Baseline","x-form-value":"items-baseline"}}} */
    @Inject
