...
/*
  ...
  "name": "Plugin",
  "componentPath": "themecleanflex/components/plugin",
  "package": "com.themecleanflex.models",
  "modelName": "Plugin",
...
@Model(
        ...
        resourceType = "themecleanflex/components/plugin",
...
//GEN]
public class PluginModel extends AbstractComponent {

    public PluginModel(final Resource r) { super(r); }

    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-label":"Javascript function to call on component mount","x-form-hint":"Function must accept (el)","x-form-type":"text","x-form-group":"content","x-default":""} */
	@Inject
	@Default(values ="")
	private String mount;

	/* {"type":"string","x-source":"inject","x-form-label":"Javascript function to call on component unmount","x-form-hint":"Function must accept (el)","x-form-type":"text","x-form-group":"content","x-default":""} */
	@Inject
	@Default(values ="")
	private String unmount;
