...
public class CodeModel extends AbstractComponent {
    ...
    //GEN[:INJECT
    	/* {"type":"string","x-source":"inject","x-form-group":"content","x-form-type":"text"} */
	@Inject
	private String language;

	/* {"type":"string","x-source":"inject","x-form-group":"style","x-form-type":"text"} */
	@Inject
	private String classes;

	/* {"type":"string","x-source":"inject","x-form-group":"content","x-form-type":"textarea","x-form-max":"16000"} */
	@Inject
	private String text;
